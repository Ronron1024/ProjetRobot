...
void PWMSetSpeed(float vitesseEnPourcents, int numeroMoteur) {
    ...
    if (numeroMoteur == 1) {
        ...
        if (vitesseEnPourcents > 0) {
            MOTEUR_GAUCHE_ENH = 1; //Pilotage de la pin en mode IO
            MOTEUR_GAUCHE_INL = 1; //Mise à 1 de la pin
            MOTEUR_GAUCHE_ENL = 0; //Pilotage de la pin en mode PWM 
        } else {
        ...
        if (vitesseEnPourcents > 0) {
            ...
            MOTEUR_DROIT_ENH = 1; //Pilotage de la pin en mode IO
            MOTEUR_DROIT_INL = 1; //Mise à 1 de la pin
            MOTEUR_DROIT_ENL = 0; //Pilotage de la pin en mode PWM
        }
